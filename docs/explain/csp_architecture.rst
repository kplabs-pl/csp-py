...
CSP follows a layered architecture similar to the Open Systems Interconnection (OSI) model, which is a conceptual framework used to understand and implement network protocols in seven layers. Each layer serves a specific function and interacts with the layers directly above and below it.
